...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/pagesnotfound \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/pagesnotfound phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/pagesnotfound/tests/phpstan/phpstan-$PS_VERSION.neon
